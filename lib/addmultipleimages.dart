...
class Addpdt1 extends StatefulWidget {

  const Addpdt1({Key? key}) : super(key: key);

  @override
  State<Addpdt1> createState() => _Addpdt1State();
}

//List<DropdownMenuItem>categoryList=[];
//Map<String,dynamic>categoryId={};
class _Addpdt1State extends State<Addpdt1> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Row(children: List.generate(imageList.length, (index){
